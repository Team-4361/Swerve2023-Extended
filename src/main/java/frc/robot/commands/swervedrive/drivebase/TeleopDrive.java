...
public class TeleopDrive extends CommandBase {
    ...
    public TeleopDrive(DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier omega,
        ...
        this.controller = Robot.swerveDrive.getSwerveController();
    ...
    public void execute() {
        ...
        if (headingCorrection) {
            ...
            ChassisSpeeds correctedChassisSpeeds = controller.getTargetSpeeds(xVelocity, yVelocity, angle,
                    Robot.swerveDrive.getHeading().getRadians());
            ...
            Robot.swerveDrive.drive(new Translation2d(xVelocity * controller.config.maxSpeed, yVelocity * controller.config.maxSpeed),
