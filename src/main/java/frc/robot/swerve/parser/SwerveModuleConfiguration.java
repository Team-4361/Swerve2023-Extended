...
import static frc.robot.swerve.math.SwerveMath.calculateDegreesPerSteeringRotation;
import static frc.robot.swerve.math.SwerveMath.calculateMaxAcceleration;
import static frc.robot.swerve.math.SwerveMath.calculateMetersPerRotation;
...
/**
 * Swerve Module configuration class which is used to configure {@link frc.robot.swerve.SwerveModule}.
 */
