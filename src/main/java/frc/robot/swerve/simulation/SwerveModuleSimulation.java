...
/**
 * Class to hold simulation data for {@link frc.robot.swerve.SwerveModule}
 */
public class SwerveModuleSimulation
{
  ...
  /**
   * Update the position and state of the module. Called from {@link frc.robot.swerve.SwerveModule#setDesiredState} function
   * when simulated.
   *
