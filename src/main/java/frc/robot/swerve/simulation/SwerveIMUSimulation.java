...
/**
 * Simulation for {@link frc.robot.swerve.SwerveDrive} IMU.
 */
public class SwerveIMUSimulation
{
  ...
  /**
   * Update the odometry of the simulated {@link frc.robot.swerve.SwerveDrive} and post the {@link frc.robot.swerve.SwerveModule}
